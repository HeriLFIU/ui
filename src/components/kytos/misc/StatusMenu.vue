      ...
      <div class="k-status-wrapper">
        <k-accordion>
          ...
          <k-accordion-item title="Refresh">
            <k-button icon="rotate-right" title="Refresh" tooltip="Refresh" @click="refresh()"></k-button>
          </k-accordion-item>
          <!--
            Sections/Tables:
              ...
              <k-accordion-item title="Filters">
                <k-button-group>
                  ...
                  <k-button :class="selectedSwitchData('ORIGINAL')" icon="database" title="Show-All" tooltip="Show-All"
                    @click="changeSwitchData('ORIGINAL')"></k-button>
                  ...
                  <k-button :class="selectedSwitchData('PRE_SELECTED')" icon="clipboard-check" title="Show-Selected"
                    tooltip="Show-Selected" @click="changeSwitchData('PRE_SELECTED')"></k-button>
                </k-button-group>
              </k-accordion-item>
                ...
                <table>
                  ...
                  <tbody>
                    <tr v-for="(item, index) in filtered_switchData" :key="item.dpid">
                      <td><k-button class="statusTableButton" :icon="isStoredS(item, index)"
                          @click="add_remove_Switches(item, index)"></k-button></td>
              ...
              <k-accordion-item title="Filters">
                <k-button-group>
                  <k-button :class="selectedLinkData('ORIGINAL')" icon="database" title="Show-All" tooltip="Show-All"
                    @click="changeLinkData('ORIGINAL')"></k-button>
                  <k-button :class="selectedLinkData('PRE_SELECTED')" icon="clipboard-check" title="Show-Selected"
                    tooltip="Show-Selected" @click="changeLinkData('PRE_SELECTED')"></k-button>
                </k-button-group>
              </k-accordion-item>
              <div class="data_status_table">
                <table>
                  ...
                  <tbody>
                    <tr v-for="(item, index) in filtered_linkData" :key="item.id" @click="show_infoPanelLink(item.id)">
                      <td><k-button class="statusTableButton" :icon="isStoredL(item, index)"
                          @click="add_remove_Links(item, index)"></k-button></td>
                      <td>{{ item.name }}</td>
                      <td :class="statusColor(item)">{{ item.status }}</td>
                      <td>{{ splitStatusReasons(item.status_reason) }}</td>
                      <td>{{ item.enabled }}</td>
              ...
              <k-accordion-item title="Filters">
                <k-button-group>
                  <k-button :class="selectedInterfaceData('ORIGINAL')" icon="database" title="Show-All"
                    tooltip="Show-All" @click="changeInterfaceData('ORIGINAL')"></k-button>
                  <k-button :class="selectedInterfaceData('PRE_SELECTED')" icon="clipboard-check" title="Show-Selected"
                    tooltip="Show-Selected" @click="changeInterfaceData('PRE_SELECTED')"></k-button>
                </k-button-group>
              </k-accordion-item>
              <div class="data_status_table">
                <table>
                  ...
                  <tbody>
                    <tr v-for="(item, index) in filtered_interfaceData" :key="item.id"
                      @click="show_infoPanelInterface(item.id)">
                      <td><k-button class="statusTableButton" :icon="isStoredI(item, index)"
                          @click="add_remove_Interfaces(item, index)"></k-button></td>
                      <td>{{ item.switch }}</td>
                      <td>{{ item.port }}</td>
                      <td :class="statusColor(item)">{{ item.status }}</td>
                      <td>{{ splitStatusReasons(item.status_reason) }}</td>
